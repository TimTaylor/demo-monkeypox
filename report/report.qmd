...
date: 2022-08-05
abstract: |
    [data](https://github.com/TimTaylor/demo-monkeypox/tree/main/data/raw),
    [analysis code](https://github.com/TimTaylor/demo-monkeypox/tree/main/R),
    [report code](https://github.com/TimTaylor/demo-monkeypox/tree/main/report/report.qmd)
format:
    html:
        self-contained: true
toc: true
